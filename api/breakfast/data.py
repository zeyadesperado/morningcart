...
EL_SOBHY_MENU = [
    ...
    ('eggs', 'Fried eggs', 'بيض مقلي', 'plate', egp(12)),
    ('basterma', 'Basterma & eggs', 'بيض بسطرمة', 'plate', egp(18)),
...
ABOU_HASSAN_MENU = [
    ...
    ('liver', 'Alexandrian liver', 'كبدة إسكندراني', 'plate', egp(20)),
    ('sausage', 'Sausage sandwich', 'ساندويتش سجق', 'plate', egp(15)),
