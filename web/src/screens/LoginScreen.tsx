      ...
      <div className="flex flex-1 flex-col justify-center pb-10">
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          ...
          <p className="mt-3 max-w-[30ch] font-sans text-base text-ink-soft text-pretty">
            Pick your name to join the table. No passwords — it’s just breakfast.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="mt-6">
            <p className="mb-2 font-sans text-2xs font-bold uppercase tracking-[0.14em] text-ink-faint">or type a name</p>
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 rounded-lg bg-card-raised px-3 py-3 font-sans text-base font-semibold text-ink ring-1 ring-line-strong placeholder:text-ink-faint focus:ring-clay"
              />
